...
❌
```shell
[move_group-7] [ERROR] [1756213182.791003172] [move_group.moveit.moveit.ros.check_start_state_bounds]: Joint 'panda_finger_joint1' from the starting state is outside bounds by: [-1.72511e-14 ] should be in the range [0.001 ], [0.04 ].
[move_group-7] [ERROR] [1756213182.791046366] [move_group.moveit.moveit.ros.check_start_state_bounds]: Joint 'panda_finger_joint2' from the starting state is outside bounds by: [-1.72511e-14 ] should be in the range [0 ], [0.04 ].
[move_group-7] [ERROR] [1756213182.791078809] [move_group]: PlanningRequestAdapter 'CheckStartStateBounds' failed, because 'Start state out of bounds.'. Aborting planning pipeline.
[move_group-7] [INFO] [1756213182.791117754] [move_group.moveit.moveit.ros.move_group.move_action]: START_STATE_INVALID
[rviz2-5] [INFO] [1756213182.791369659] [moveit_3299154995.moveit.ros.move_group_interface]: Plan and Execute request aborted
```
